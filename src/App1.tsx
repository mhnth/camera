    ...
    if (
      ...
      const cutImageIntoEllipseVirtual = () => {
        if (!video.paused && !video.ended && virtualContext) {
          ...
          // virtualCanvas.width = window.innerWidth;
          // virtualCanvas.height = window.innerWidth / aspectRatio;
          ...
          // virtualContext.globalCompositeOperation = 'destination-out';
      ...
      const cutImageIntoEllipse = () => {
        if (!video.paused && !video.ended && context) {
          ...
          context.ellipse(
            ...
            canvas.height / 3, // Y coordinate of the center
            canvas.width / 4, // Horizontal radius
            canvas.height / 3.95, // Vertical radius (adjust as needed)
            0, // Rotation angle (0 for vertical)
            0, // Start angle
            Math.PI * 2 // End angle
          );
          ...
          context.lineWidth = 4; // Increase the line width as needed
  ...
  return (
    <div className="cam-holder">
      ...
      <div className="captureBox">
        <div onClick={cutAndDisplayImage} className="circleOuter">
